...
class Contract(models.Model):
    ...
    estimated_cost = fields.Float(string='Price', related='work_ids.estimated_cost')
    ...
    company_signatory_title=fields.Char(string='Company Signatory Title',default=lambda self: self.env.user.company_id.name)
    ...
    def button_payment_request(self):
        ...
        #         'unit_price': line.unit_price,
        #     })]
        # create_payment_request.update({'contract_ids': lines})
