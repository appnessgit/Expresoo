...
//        });
    ...
    fetch_data: function() {
        ...
        var def1 =  this._rpc({
            ...
            console.log(self.login_employee);
...
//        );
    ...
    hr_appraisal: function(e) {
        console.log("hr_appraisal")
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        this.do_action({
            name: _t("Appraisal Request"),
            type: 'ir.actions.act_window',
            res_model: 'hr.appraisal',
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['emp_id','=', this.login_employee.id]],
            target: 'current'
        }, options)
    },
    hr_loan: function(e) {
        ...
        this.do_action({
            name: _t("Loans Request"),
            type: 'ir.actions.act_window',
            res_model: 'hr.loan',
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['employee_id','=', this.login_employee.id],['state','in',['to_approve','approve']]],
            target: 'current'
        }, options)
    },
    hr_overtime: function(e) {
        console.log("hr_overtime")
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
        ...
        today = mm + '/' + dd + '/' + yyyy;
        console.log("Fist day of month " + today);
        ...
        this.do_action({
            ...
            view_mode: 'tree,form,calendar',
            views: [[false, 'list'],[false, 'form']],
            domain: [['employee_id','=', this.login_employee.id],['date','>=',today]],
            target: 'current'
        }, options)
    },
...
core.action_registry.add('o_hr_dashboard', HrDashboard);
