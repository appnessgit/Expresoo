...
class Contract(models.Model):
    ...
    wage = fields.Monetary(string='Take Home', compute="get_gross", store=True, required=False)
    ...
    #     for rec in self:
    #         if int(rec.wage) > int(rec.max):
    #             raise UserError(_("The Gross Is More Than This Grade Maximoum Amount"))
    #         if int(rec.wage) < int(rec.min):
    #             raise UserError(_("The Gross Is Less Than This Grade Minimoum Amount"))
